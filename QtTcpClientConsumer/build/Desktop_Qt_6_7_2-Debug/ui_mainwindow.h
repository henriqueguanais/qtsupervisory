...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(listWidgetIPs, 2, 1, 1, 1);

        pushButtonUpdate = new QPushButton(centralWidget);
        pushButtonUpdate->setObjectName("pushButtonUpdate");
        pushButtonUpdate->setMaximumSize(QSize(16777215, 25));

        gridLayout->addWidget(pushButtonUpdate, 3, 1, 1, 1);
        ...
        widgetPlot->setStyleSheet(QString::fromUtf8(""));
        ...
        QObject::connect(horizontalSliderTiming, &QSlider::valueChanged, labelTimingValue, qOverload<int>(&QLabel::setNum));
